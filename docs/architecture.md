...
Этот файл описывает установленную версию. Целевая схема с Gemini Transcribe, Denis и самостоятельным циклом управления компьютером описана отдельно: [самостоятельное управление](autonomous-computer-use.md).
